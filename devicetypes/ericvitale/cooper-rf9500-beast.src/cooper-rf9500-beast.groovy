...
metadata {
	...
	tiles {
		...
		valueTile("Brightness", "device.level", width: 1, height: 1) { state "level", label: '${currentValue}%' }

		controlTile("levelSliderControl", "device.level", "slider", width: 3, height: 1) { state "level", action:"level.setLevel" }
